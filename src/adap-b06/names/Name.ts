...
export interface Name extends Cloneable, Printable, Equality {
    ...
    /** * Returns a new Name instance with the component set at the specified index.
     * Expects that new Name component c is properly masked 
     */
    setComponent(i: number, c: string): Name;

    /** * Returns a new Name instance with the component inserted at the specified index.
     * Expects that new Name component c is properly masked 
     */
    ...
    /**
     * Returns a new Name instance with the component removed at the specified index.
     */
